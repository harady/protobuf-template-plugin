...
public partial class ResourceLotteryData : IUnique<long>
{
	...
	{
		targetDataTable.CreateUniqueIndex("Resourcelotterydata", aData => (object)aData.resourcelotterydata);
		targetDataTable.CreateIndex("Resourcelotterydata", aData => (object)aData.resourcelotterydata);
		targetDataTable.CreateIndex("Resourcelotterydata", aData => (object)aData.resourcelotterydata);
		targetDataTable.CreateIndex("Resourcelotterydata", aData => (object)aData.resourcelotterydata);
	}
	#endregion
