...
namespace AwsDotnetCsharp
{
	public partial class ConfigData : IUnique<long>
	{
			...
			ConfigData data)
		{
			...
			if (result) { userUpdateCache.configTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<ConfigData> dataList)
		{
			...
			if (result) { userUpdateCache.configTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.configTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.configTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
