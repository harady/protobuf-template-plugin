...
namespace AwsDotnetCsharp
{
	public partial class ExchangeItemData : IUnique<long>
	{
			...
			ExchangeItemData data)
		{
			...
			if (result) { userUpdateCache.exchangeItemTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<ExchangeItemData> dataList)
		{
			...
			if (result) { userUpdateCache.exchangeItemTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.exchangeItemTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.exchangeItemTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
