...
namespace AwsDotnetCsharp
{
	public partial class MessageData : IUnique<long>
	{
			...
			MessageData data)
		{
			...
			if (result) { userUpdateCache.messageTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<MessageData> dataList)
		{
			...
			if (result) { userUpdateCache.messageTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.messageTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.messageTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
