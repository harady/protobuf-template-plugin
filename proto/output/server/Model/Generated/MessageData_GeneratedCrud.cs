...
namespace AwsDotnetCsharp
{
	...
	public partial class MessageData : IUnique<long>
	{
		...
		private static IMongoCollection<MessageData> collection
			=> _collection ?? (_collection = mongoDatabase.GetCollection<MessageData>("MessageDatas"));
			...
			MessageData data)
		{
			...
			if (result) { userUpdateCache.MessageDataTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<MessageData> dataList)
		{
			...
			if (result) { userUpdateCache.MessageDataTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.MessageDataTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.MessageDataTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
		...
		public static List<MessageData> GetDataListById(
			long id)
		{
		...
		public static List<MessageData> GetDataListByName(
			string name)
		{
