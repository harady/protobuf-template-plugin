...
namespace AwsDotnetCsharp
{
	...
	public partial class UserShopItemData : IUnique<long>
	{
		...
		private static IMongoCollection<UserShopItemData> collection
			=> _collection ?? (_collection = mongoDatabase.GetCollection<UserShopItemData>("UserShopItemDatas"));
			...
			UserShopItemData data)
		{
			...
			if (result) { userUpdateCache.UserShopItemDataTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<UserShopItemData> dataList)
		{
			...
			if (result) { userUpdateCache.UserShopItemDataTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.UserShopItemDataTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.UserShopItemDataTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
