...
namespace AwsDotnetCsharp
{
	public partial class SkillData : IUnique<long>
	{
			...
			SkillData data)
		{
			...
			if (result) { userUpdateCache.skillTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<SkillData> dataList)
		{
			...
			if (result) { userUpdateCache.skillTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.skillTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.skillTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
