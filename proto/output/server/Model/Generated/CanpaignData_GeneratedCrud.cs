...
namespace AwsDotnetCsharp
{
	...
	public partial class CanpaignData : IUnique<long>
	{
		...
		private static IMongoCollection<CanpaignData> collection
			=> _collection ?? (_collection = mongoDatabase.GetCollection<CanpaignData>("CanpaignDatas"));
			...
			CanpaignData data)
		{
			...
			if (result) { userUpdateCache.CanpaignDataTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<CanpaignData> dataList)
		{
			...
			if (result) { userUpdateCache.CanpaignDataTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.CanpaignDataTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.CanpaignDataTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
		...
		public static List<CanpaignData> GetDataListById(
			long id)
		{
		...
		public static List<CanpaignData> GetDataListByName(
			string name)
		{
