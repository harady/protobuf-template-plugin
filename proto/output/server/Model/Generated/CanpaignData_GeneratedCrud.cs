...
namespace AwsDotnetCsharp
{
	public partial class CanpaignData : IUnique<long>
	{
			...
			CanpaignData data)
		{
			...
			if (result) { userUpdateCache.canpaignTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<CanpaignData> dataList)
		{
			...
			if (result) { userUpdateCache.canpaignTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.canpaignTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.canpaignTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
