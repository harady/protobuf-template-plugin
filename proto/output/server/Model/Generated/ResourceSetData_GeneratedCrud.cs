...
namespace AwsDotnetCsharp
{
	...
	public partial class ResourceSetData : IUnique<long>
	{
		...
		private static IMongoCollection<ResourceSetData> collection
			=> _collection ?? (_collection = mongoDatabase.GetCollection<ResourceSetData>("ResourceSetDatas"));
			...
			ResourceSetData data)
		{
			...
			if (result) { userUpdateCache.ResourceSetDataTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<ResourceSetData> dataList)
		{
			...
			if (result) { userUpdateCache.ResourceSetDataTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.ResourceSetDataTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.ResourceSetDataTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
		...
		public static List<ResourceSetData> GetDataListById(
			long id)
		{
		...
		public static List<ResourceSetData> GetDataListByName(
			string name)
		{
