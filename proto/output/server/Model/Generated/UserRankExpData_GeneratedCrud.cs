...
namespace AwsDotnetCsharp
{
	public partial class UserRankExpData : IUnique<long>
	{
			...
			UserRankExpData data)
		{
			...
			if (result) { userUpdateCache.userRankExpTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<UserRankExpData> dataList)
		{
			...
			if (result) { userUpdateCache.userRankExpTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.userRankExpTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.userRankExpTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
