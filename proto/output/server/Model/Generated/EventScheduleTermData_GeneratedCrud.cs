...
namespace AwsDotnetCsharp
{
	public partial class EventScheduleTermData : IUnique<long>
	{
			...
			EventScheduleTermData data)
		{
			...
			if (result) { userUpdateCache.eventScheduleTermTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<EventScheduleTermData> dataList)
		{
			...
			if (result) { userUpdateCache.eventScheduleTermTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.eventScheduleTermTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.eventScheduleTermTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
