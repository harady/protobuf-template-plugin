...
namespace AwsDotnetCsharp
{
	public partial class StageSpecialRewardData : IUnique<long>
	{
			...
			StageSpecialRewardData data)
		{
			...
			if (result) { userUpdateCache.stageSpecialRewardTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<StageSpecialRewardData> dataList)
		{
			...
			if (result) { userUpdateCache.stageSpecialRewardTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.stageSpecialRewardTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.stageSpecialRewardTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
