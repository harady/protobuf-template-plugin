...
namespace AwsDotnetCsharp
{
	public partial class AdviceData : IUnique<long>
	{
			...
			AdviceData data)
		{
			...
			if (result) { userUpdateCache.adviceTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<AdviceData> dataList)
		{
			...
			if (result) { userUpdateCache.adviceTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.adviceTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.adviceTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
