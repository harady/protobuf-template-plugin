...
namespace AwsDotnetCsharp
{
	public partial class MissionData : IUnique<long>
	{
			...
			MissionData data)
		{
			...
			if (result) { userUpdateCache.missionTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<MissionData> dataList)
		{
			...
			if (result) { userUpdateCache.missionTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.missionTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.missionTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
