...
namespace AwsDotnetCsharp
{
	public partial class ShopScheduleData : IUnique<long>
	{
			...
			ShopScheduleData data)
		{
			...
			if (result) { userUpdateCache.shopScheduleTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<ShopScheduleData> dataList)
		{
			...
			if (result) { userUpdateCache.shopScheduleTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.shopScheduleTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.shopScheduleTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
