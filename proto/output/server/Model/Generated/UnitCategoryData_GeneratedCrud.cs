...
namespace AwsDotnetCsharp
{
	public partial class UnitCategoryData : IUnique<long>
	{
			...
			UnitCategoryData data)
		{
			...
			if (result) { userUpdateCache.unitCategoryTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<UnitCategoryData> dataList)
		{
			...
			if (result) { userUpdateCache.unitCategoryTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.unitCategoryTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.unitCategoryTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
