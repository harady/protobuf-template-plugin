...
namespace AwsDotnetCsharp
{
	public partial class ItemData : IUnique<long>
	{
			...
			ItemData data)
		{
			...
			if (result) { userUpdateCache.itemTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<ItemData> dataList)
		{
			...
			if (result) { userUpdateCache.itemTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.itemTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.itemTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
