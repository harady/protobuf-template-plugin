...
namespace AwsDotnetCsharp
{
	public partial class EnemyActionData : IUnique<long>
	{
			...
			EnemyActionData data)
		{
			...
			if (result) { userUpdateCache.enemyActionTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<EnemyActionData> dataList)
		{
			...
			if (result) { userUpdateCache.enemyActionTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.enemyActionTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.enemyActionTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
