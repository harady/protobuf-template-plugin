...
namespace AwsDotnetCsharp
{
	...
	public partial class EnemyActionData : IUnique<long>
	{
		...
		private static IMongoCollection<EnemyActionData> collection
			=> _collection ?? (_collection = mongoDatabase.GetCollection<EnemyActionData>("EnemyActionDatas"));
			...
			EnemyActionData data)
		{
			...
			if (result) { userUpdateCache.EnemyActionDataTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<EnemyActionData> dataList)
		{
			...
			if (result) { userUpdateCache.EnemyActionDataTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.EnemyActionDataTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.EnemyActionDataTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
