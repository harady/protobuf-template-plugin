...
namespace AwsDotnetCsharp
{
	public partial class LogData : IUnique<long>
	{
			...
			LogData data)
		{
			...
			if (result) { userUpdateCache.logTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<LogData> dataList)
		{
			...
			if (result) { userUpdateCache.logTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.logTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.logTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
