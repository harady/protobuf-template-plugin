...
namespace AwsDotnetCsharp
{
	public partial class ExchangeData : IUnique<long>
	{
			...
			ExchangeData data)
		{
			...
			if (result) { userUpdateCache.exchangeTableUpdate.Upsert(data); }
			return result;
		}
			...
			IEnumerable<ExchangeData> dataList)
		{
			...
			if (result) { userUpdateCache.exchangeTableUpdate.Upsert(dataList); }
			return result;
		}
		#endregion
		#region MongoDb
			...
			long id)
		{
			...
			if (result) { userUpdateCache.exchangeTableUpdate.Delete(id); }
			return result;
		}
			...
			IEnumerable<long> ids)
		{
			...
			var result = deleteResult.IsAcknowledged;
			if (result) { userUpdateCache.exchangeTableUpdate.Delete(ids); }
			return result;
		}
		#endregion
		#region NullObject
